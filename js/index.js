(function () {
    ...
    var slide3 = {
        ...
        href: {
            ...
            b: "https://github.com/Danielmoffitt54/Weather-Site",
            c: "https://github.com/Danielmoffitt54/Pokemon-API-Site",
        ...
        description: {
            ...
            b: "Search for a location by Address, City, or Zip code, and get information on the current weather and the forecast for the next five days.",
            c: "Online pokedex with an input linked to and API. The user can search for Pokemon by ID number or by name and then retrieve data from PokeAPI to be displayed below the header.",
